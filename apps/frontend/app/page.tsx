  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <button className="bg-transparent hover:bg-white/10 text-white px-4 h-10 rounded-md transition-colors border border-white/20">Login</button>
              <button className="bg-white text-black hover:bg-gray-100 px-4 h-10 rounded-md transition-colors">Get Started</button>
            </nav>
      ...
      <main>
        ...
        <section className="pt-28 pb-20 md:pt-36 md:pb-32 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="text-center max-w-4xl mx-auto">
              <div className="mb-6 inline-flex items-center px-3 py-1 rounded-full bg-white/5 border border-white/10 text-white/80 text-sm">
                <span className="inline-block w-2 h-2 rounded-full bg-white mr-2 animate-pulse"></span>
                99.9% Uptime Guaranteed
              </div>

              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight leading-tight">
                Never Miss a Beat with <span className="text-white">Better</span> Uptime Monitoring
              </h1>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
                <a href='/dashboard' className="inline-flex items-center justify-center px-6 h-12 text-lg font-medium bg-white text-black rounded-md hover:bg-gray-100 transition-colors">
                  Start Monitoring <ArrowRight className="ml-2 h-5 w-5" />
                </a>
                <button className="inline-flex items-center justify-center px-6 h-12 text-lg font-medium border border-white/20 text-white rounded-md hover:bg-white/10 transition-colors">
                  Watch Demo
                </button>
              </div>
            </div>
        ...
        {/* Features Section */}
        <section id="features" className="py-20 bg-black border-t border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Everything You Need for <span className="text-white">Complete</span> Monitoring
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <div key={index} className="rounded-xl bg-white/5 border border-white/10 p-6 hover:shadow-lg hover:shadow-white/5 hover:border-white/20 transition-all duration-200">
                  <div className="p-3 rounded-lg inline-flex bg-white/10 mb-3">
                    {feature.icon}
                  </div>
        ...
        {/* Pricing Section */}
        <section id="pricing" className="py-20 bg-black border-t border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {pricingPlans.map((plan, index) => (
                <div
                  key={index}
                  className={`rounded-xl bg-white/5 border ${
                    plan.popular ? 'border-white shadow-lg shadow-white/10' : 'border-white/10'
                  } p-6 relative`}
                >
                  {plan.popular && (
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white text-black text-xs font-bold px-4 py-1 rounded-full">
                      MOST POPULAR
                    </div>
                  )}
                  ...
                  <div className="flex mb-4">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <Star
                        key={i}
                        className={`h-5 w-5 ${
                          i < testimonial.stars ? 'text-white fill-white' : 'text-gray-600'
                        }`}
                      />
                    ))}
                  </div>

                  <blockquote className="text-gray-200 mb-6">
                    "{testimonial.quote}"
                  </blockquote>
        ...
        {/* CTA Section */}
        <section className="py-20 bg-black relative overflow-hidden border-t border-white/10">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
                Start Monitoring Your Services <span className="text-white">Today</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
                <button className="inline-flex items-center justify-center px-6 h-12 text-lg font-medium bg-white text-black rounded-md hover:bg-gray-100 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            <div className="lg:col-span-2">
              <div className="flex items-center text-white mb-4">
                <Monitor className="h-6 w-6 text-white mr-2" />
